          ...
          <div className={styles.docs}>
                  ...
                  <li className={styles.menuItem}>
                    ...
                    <ul className={styles.submenu}>
                      <li className={styles.submenuItem}>
                        <a href="#" className={`${styles.menuLink} ${styles.menuLinkSelected}`}>
                          Quickstart
                        </a>
                      </li>
            ...
            <div className={styles.wrapper}>
              <div className={styles.header}>
                ...
                <a href="#" className={`${styles.headerLink} btn btn-sm btn-primary`}>
                  Create Account
                </a>
                <a href="#" className={`${styles.headerLink} ml-4`}>
                  Support
                </a>
                <a href="#" className={`${styles.headerLink} ml-4`}>
              ...
              <article className={styles.content}>
                <header>
                  ...
                  <p>
                    ...
                    <a href="#">support@cleanuitemplate.com</a>.
                  </p>
                </header>
                <section>
                  <p>
                  ...
                  <ul>
                    ...
                    <li>
                      <a href="#">Issue stock</a> to founders of a C Corporation
                    </li>
                    <li>
                      Obtain a U.S.
                      <a href="#">Employer Identification Number</a>
                      (EIN) for tax purposes
                    </li>
                    <li>
                      <p>
                        Open a U.S.
                        <a href="#">business bank account</a>
                      </p>
                    </li>
                    <li>
                      Create a U.S.
                      <a href="#">Clean Pay account</a> to accept payments from around the world
                    </li>
                    <li>
                      Connect to <a href="#">legal</a> and
                      <a href="#">tax</a> experts
                    </li>
                    <li>
                    ...
                    <li>
                      Join the <a href="#">Clean Pay Community</a>, a global community of
                ...
                <section>
                  ...
                  <p>
                    ...
                    Pay has a <a href="#">one-time fee</a> of $500 (all prices are in USD) that
                    covers:
                  </p>
                  <ul>
                    ...
                    <li>
                      Your first year of Delaware <a href="#">registered agent</a>
                      services
                    </li>
                ...
                <section>
                  ...
                  <p>
                    Once you start your <a href="#">application</a>:
                  </p>
                  <ol>
                    <li>
                  ...
                  <p>
                    We’ll <a href="#">take it from there</a>, sending you emails as steps are
                    completed, and letting you know when we need more information. You can also
                    track the progress in the <a href="#">Dashboard</a>.
                  </p>
                </section>
                <section>
                  <h2>Next steps</h2>
                ...
                <section>
                  <aside className={styles.note}>
                    ...
                    <p>
                      ...
                      <a href="#">account settings</a>. Reports, API responses, and the timing of
                      your subscriptions and payouts always use
                      <a href="#">UTC</a> (Coordinated Universal Time).
                    </p>
                    <p>
                  ...
                  <p>
                    ...
                    processing payments. Use the <a href="#">Dashboard</a> to view information about
                    the different types of account activity, which can be exported into a
                  ...
                  <ul>
                    <li>
                      Other kinds of payments (e.g., <a href="#">ACH</a>)
                    </li>
                    <li>
                    ...
                    <li>
                      Fees for <a href="#">manual payouts</a>
                    </li>
                  </ul>
                ...
                <section>
                  ...
                  <p>
                    Balance transactions include a<a href="#">source</a> field which contains the ID
                    of the related Clean Pay object. The <a href="#">API</a> can be used to retrieve
                    additional information about the payment activity that caused the Balance
                    transaction to be created. Using <a href="#">Sigma</a>, you can also join the
                ...
                <section>
                  ...
                  <p>
                    ...
                    <a href="#">Search</a>
                    our documentation, <a href="#">contact support</a>, or
                    <a href="#">connect with our sales team</a>. You can also chat live with other
                    developers in <a href="#">#cleanuiadmintemplate</a> on freenode.
                  </p>
                </section>
                <section>
                  <h2>
                  ...
                  <aside className={styles.important}>
                    <p>
                      ...
                      to complete a<a href="#">Report on Compliance</a>
                ...
                <section>
                  <dl>
                    ...
                    <dd>
                      ...
                      <a href="#">deferred account</a> already has an account associated with it.
                      Use the
                      <a href="#">OAuth flow</a>

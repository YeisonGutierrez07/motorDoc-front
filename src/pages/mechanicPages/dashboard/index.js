...
class DashboardMechanic extends React.Component {
  ...
  render() {
    const {company, workshop, ordersGraph, amountGraph, lastClients} = this.state
            ...
            <Row gutter={20}>
              <Col xs={24}>
                <div className="card">
                  ...
                  <Row gutter={20}>
                    <Col md={12} xs={24}>
                      <MoreInfoCard moreData={{logo: company.logo, name: company.business_name, more: `NIT:${  company.nit}` }} modalData={company} type={1} />
                    </Col>
                    <Col md={12} xs={24}>
                      <MoreInfoCard moreData={{logo: workshop.logo, name: workshop.name, more: `Dirección:${  workshop.address}` }} modalData={workshop} type={2} />
                    </Col>
                  </Row>
                </div>
              </Col>
